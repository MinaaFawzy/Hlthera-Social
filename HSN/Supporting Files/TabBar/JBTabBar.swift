...
public class JBTabBar: UITabBar {
    ...
    func setupTabBar() {
        ...
        tabBarCurveShapeLayer.fillColor = UIColor(named:"Card Background Color")!.cgColor
        tabBarCurveShapeLayer.strokeColor = UIColor(named:"Card Background Color")!.cgColor
