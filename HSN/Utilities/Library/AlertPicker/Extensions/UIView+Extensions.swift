...
extension UIView {
    ...
    public var cornerRadius: CGFloat {
        ...
        set {
            if bounds.size.height == 45 {
                layer.cornerRadius = circleCorner ? min(bounds.size.height, bounds.size.width) / 2 :  bounds.size.height / 2
            }else {
...
public extension UIView {
    ...
    func roundedCornersNew(corners : UIRectCorner, radius : CGFloat) {
