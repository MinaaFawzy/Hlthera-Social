...
class FitnessPointsVC: UIViewController {

    @IBOutlet weak var buttonDay: UIButton!
    
    @IBOutlet weak var viewFitnessPoints: UIView!
    ...
    override func viewDidLoad() {
        ...
        DispatchQueue.main.async {
            self.viewFitnessPoints.applyGradient(colours: [#colorLiteral(red: 0.9607843137, green: 0.968627451, blue: 0.9764705882, alpha: 1), #colorLiteral(red: 0.8470588235, green: 0.8745098039, blue: 0.9137254902, alpha: 1)])
        }
    }
...
//
    ...
    @IBAction func buttonWeekTapped(_ sender: UIButton) {
        buttonWeek.backgroundColor = UIColor(hexString: "#2E7AC5")
