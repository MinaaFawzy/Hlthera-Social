...
class CreateNewEventVC: UIViewController, UITextFieldDelegate {
...
//        var image:[[String:Any]] = [["imageName":ApiParameters.cover_pic,"image":self.imageCover.image],["imageName":"event_pic","image":self.imageEventIcon.image]]
        ...
        var image:[[String:Any]] = [["imageName":"event_pic","image":self.imageCover.image]]
...
extension CreateNewEventVC:GMSMapViewDelegate,CLLocationManagerDelegate{
